...
TRAIN_MEAN_PATH = os.path.join(BASE_DIR, "models", "train_mean.npy")
TRAIN_STD_PATH  = os.path.join(BASE_DIR, "models", "train_std.npy")
...
if st.button("🔍 Analyze ECG"):
    ...
    for beat in beats:
        # 🔑 CRITICAL CHANGE: training-consistent normalization
    ...
    if abnormal_count >= 1:
        ...
        st.caption("⚕️ *This screening tool cannot diagnose conditions.*")
    else:
